...
import { IOffice, IOfficeDTO } from 'app/shared/model/office.model';
...
export class OfficeService {
  ...
  create(office: IOfficeDTO): Observable<EntityResponseType> {
    return this.http.post<IOffice>(this.resourceUrl, office, { observe: 'response' });
  }

  update(office: IOfficeDTO): Observable<EntityResponseType> {
