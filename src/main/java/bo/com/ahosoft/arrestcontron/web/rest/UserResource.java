...
import bo.com.ahosoft.arrestcontron.service.MailService;
import bo.com.ahosoft.arrestcontron.service.UserQueryService;
import bo.com.ahosoft.arrestcontron.service.UserService;
...
import bo.com.ahosoft.arrestcontron.web.rest.errors.EmailAlreadyUsedException;
import bo.com.ahosoft.arrestcontron.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    @PreAuthorize("hasRole(\"" + AuthoritiesConstants.ADMIN + "\") or hasRole(\"" + AuthoritiesConstants.UNIT + "\")")
    public ResponseEntity<Void> resetPasswordUser(@PathVariable Long id) {
        log.debug("REST request to reset User: {}", id);
        userService.resetPasswordUser(id);
        return ResponseEntity.noContent().headers(HeaderUtil.createAlert(applicationName,  "userManagement.resetPassword", id.toString())).build();
    }
}
